...
if __name__ == "__main__":
    ...
    train_split, test_split = create_splits(
        audio_dirs=['/home/xinyu.li/raw_audio/part-new/', '/home/xinyu.li/raw_audio/part-1-5/', '/home/xinyu.li/raw_audio/part-6-10/'],
        split_ratio=train_test_ratio,
        rng_seed=42,
        mode=args.mode,
    )
    # os.makedirs('~/processed_data', exist_ok=True)
    train_set = MainstageDataset(data_list=train_split, use_chroma=args.use_chroma, audio_standalone_dir=f'/home/xinyu.li/raw_audio/standalone_train/')
    val_set = MainstageDataset(data_list=test_split, use_chroma=args.use_chroma, audio_standalone_dir=f'/home/xinyu.li/raw_audio/standalone_test/')
    torch.save(train_set, f'/home/xinyu.li/processed_data/train_set_{args.mode}_{str(args.use_chroma)}.pth')
    torch.save(val_set, f'/home/xinyu.li/processed_data/test_set_{args.mode}_{str(args.use_chroma)}.pth')
